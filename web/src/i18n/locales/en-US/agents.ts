const agents = {
  ...
  'agents.computeTier.description': 'Switch the model and thinking strength of writing sub-agents by stage. An explicit model set on an individual sub-agent overrides the tier. Applies to Writing Mode only.',
  ...
  'agents.computeTier.note': 'The tier chosen here is saved to user config and mirrored in the Writing composer. It affects the writing pipeline only; Interactive Mode is unaffected.',
