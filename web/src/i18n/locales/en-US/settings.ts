const settings = {
  ...
  'settings.quickActions.intent': 'Task Type',
  'settings.quickActions.intentAuto': 'Auto Detect',
  'settings.quickActions.intentPlanning': 'Planning / Analysis',
  'settings.quickActions.intentProseGeneration': 'Prose Generation',
  'settings.quickActions.intentProseRevision': 'Prose Revision',
  'settings.quickActions.intentReviewApplication': 'Apply Review Feedback',
  'settings.quickActions.intentAnalysis': 'Read-only Check',
